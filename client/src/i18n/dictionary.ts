...
const en: Dict = {
  ...
  "adv.umbrella": "Carry an umbrella",
  "adv.umbrellaWhy": "Seeded rain probability reaches {pct}% during the day.",
...
const hi: Dict = {
  ...
  "adv.umbrellaWhy": "संग्रहीत वर्षा संभावना दिन में {pct}% तक पहुँचती है।",

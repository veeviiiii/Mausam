...
const en: Dict = {
  ...
  "adv.umbrellaWarnWhy": "{event} — {level} warning, active until {until}.",
  ...
  "src.status.seeded": "Seeded",
  "src.status.derived": "Derived",
  "src.seed": "demo dataset, not a live feed",
  "src.cpcb": "CPCB · {station}",
  "src.cpcbNoStation": "no CPCB station in {place}",
  "src.cap": "NDMA Sachet · {office}",
  "src.illustrative": "illustrative example, no urban nowcast source",
  "sheet.seededEyebrow": "Seeded bulletin · {place}",
  "adv.lowVisibility": "Allow extra time on the road",
  "adv.lowVisibilityWhy": "Visibility is {v} km. IMD's fog bands start at 1 km, so this is our own driving caution, not a fog warning.",
  ...
  "adv.fogLightsWhy": "Visibility is {m} m — inside IMD's shallow-fog band, which starts at 1000 m.",
  ...
  "adv.schoolUmbrellaWhy": "Seeded rain probability reaches {pct}% inside a school window.",
  ...
  "source.fitness": "IMD hourly shape · seeded",
  "source.beach": "No marine feed · seeded",
  "source.travel": "NDMA CAP · forecast seeded",
...
const hi: Dict = {
  ...
  "adv.umbrellaWarnWhy": "{event} — {level} चेतावनी, {until} तक सक्रिय।",
  ...
  /* ---- advisories ---- */
  "src.status.live": "लाइव",
  "src.status.seeded": "संग्रहीत",
  "src.status.derived": "व्युत्पन्न",
  "src.seed": "डेमो डेटा, लाइव फ़ीड नहीं",
  "src.cpcb": "CPCB · {station}",
  "src.cpcbNoStation": "{place} में CPCB स्टेशन नहीं",
  "src.cap": "NDMA सचेत · {office}",
  "src.illustrative": "उदाहरण मात्र, शहरी नाउकास्ट स्रोत नहीं",
  "sheet.seededEyebrow": "संग्रहीत बुलेटिन · {place}",
  "adv.lowVisibility": "सड़क पर अतिरिक्त समय रखें",
  "adv.lowVisibilityWhy": "दृश्यता {v} किमी है। IMD के कोहरा बैंड 1 किमी से शुरू होते हैं, इसलिए यह हमारी अपनी ड्राइविंग सावधानी है, कोहरा चेतावनी नहीं।",
  ...
  "adv.fogLightsWhy": "दृश्यता {m} मी है — IMD के उथले कोहरे के बैंड में, जो 1000 मी से शुरू होता है।",
  ...
  "adv.schoolUmbrellaWhy": "संग्रहीत वर्षा संभावना स्कूल के समय के भीतर {pct}% तक पहुँचती है।",
  ...
  "source.fitness": "IMD घंटेवार ढाँचा · संग्रहीत",
  "source.beach": "कोई समुद्री फ़ीड नहीं · संग्रहीत",
  "source.travel": "NDMA CAP · पूर्वानुमान संग्रहीत",
